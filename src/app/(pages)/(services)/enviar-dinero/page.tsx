...
const CrearTransaccionPage = () => {
  ...
  // Función para crear una transacción y luego crear la transferencia
  const handleCreateTransaccion = async () => {
    ...
    try {
      ...
      const transaccionId = transaccionResponse.data.id; // Suponemos que la API devuelve el ID de la transacción

      // Crear la transferencia asociada
      ...
      alert("Transacción y transferencia creadas exitosamente.");
    } catch (error) {
      console.error("Error al crear la transacción o transferencia:", error);
      alert("Hubo un error al crear la transacción o transferencia.");
    }
  };
